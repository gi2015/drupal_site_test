...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupalcore_localhost_ACN_clone_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupalcore_localhost_ACN_clone_dd.inc';
}
// </DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/jgpc2004ga/jgpc2004ga-settings.inc');
}
